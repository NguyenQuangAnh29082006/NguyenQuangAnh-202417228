...
// Pre-load some sample media items into the store inventory
        DigitalVideoDisc dvd = new DigitalVideoDisc("The Lion King", "Animation", "Roger Allers", 89, 19.95f);
        ...
        while (true) {
            ...
            switch (choice) {
                ...
                case 3:
                    ...
                    // Implement play logic  (Check if it's a DVD/CD and cast it)
                    break;
                case 4:
                    cart.print();
                    cartMenu();
                    break;
                case 0:
                    return; // Drops back out to the Main Menu
                default:
                    System.out.println("Invalid option. Please try again.");
            }
        }
        ...
        while (true) {
            ...
            switch (choice) {
                ...
                case 5:
                    ...
                    cart = new Cart(); // Wipes the cart clean
                    return;
                case 0:
                    return; // Drops back to the previous menu loop
                default:
                    System.out.println("Invalid option. Please try again.");
            }
        }
